---
headline: "Building answer engine optimization into a live channel before the category had a name."
dek: "Search returns a list you compete on. Answer engines return one synthesis you either appear inside or you don't. That is a different unit of competition, and it needed a different content shape, a different measurement model and a different sell to clients."
...
whatGotBuilt:
  ...
  - "Built a new measurement framework for tracking answer presence rather than page ranking"
  - "Repositioned the offering for client-facing sales conversations"
metrics: []
scope: "Chief Marketing Officer. Owned strategy, measurement framework and client-facing positioning. Execution through SEO and content teams."
needs:
  - "Outcome metrics: citation share, answer presence by query class, client wins, revenue attributed, or growth of the practice"
---

<!-- NEEDS: outcome metrics for this case study -->
